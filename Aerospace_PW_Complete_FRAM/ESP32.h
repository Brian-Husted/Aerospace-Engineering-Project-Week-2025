...
#define launch_alt 20  //altitude in meters for failsafe detection of launch
...
bool dataStream = true;  //true sends data to serial monitor and BT Serial every 50ms
